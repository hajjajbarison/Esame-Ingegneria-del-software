 ...
 * by a call to next(). In a list of length n, there are n+1 valid index values, from 0 to n, inclusive.
 * <pre>
...
public interface HListIterator extends HIterator{
	 ...
	 * @throws IllegalStateException neither next nor previous have been called, or remove or add have been called after the last call to * next
	 */
	void remove();
	 ...
	 * @throws UnsupportedOperationException if the add operation is not supported by this list iterator.
	 * @throws ClassCastException if the class of the specified element prevents it from being added to this list.
	 * @throws IllegalArgumentException if some aspect of the specified element prevents it from being added to this list.
	 */
	void add(Object o);
